...
$query = "SELECT * FROM tblmember WHERE status = 'approved' AND typeMember = 'With Instructor Member'";
    ...
    <div class="main">
        <div class="header">
            ...
            <div class="btn-con">
                ...
                <button id="btnWithTrainorMembers" class="active-btn">Personal Trainer Members</button>
            </div>
                        ...
                        <?php if ($result && mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo date("F j, Y g:ia", strtotime($row['endDate'])); ?></td>
                            ...
                            <tr>
                                <td colspan="12" style="text-align: center;">No Monthly Members</td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
