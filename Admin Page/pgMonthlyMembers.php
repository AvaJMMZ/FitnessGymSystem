...
$query = "SELECT * FROM tblmember WHERE status = 'approved' AND typeMember = 'Monthly Member'";
    ...
    <div class="main">
        <div class="header">
            ...
            <div class="btn-con">
                ...
                <button id="btnMontlyMembers" class="active-btn">Monthly Members</button>
